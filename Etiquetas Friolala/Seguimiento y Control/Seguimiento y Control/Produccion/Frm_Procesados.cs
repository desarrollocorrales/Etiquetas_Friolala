...
namespace Seguimiento_y_Control.Produccion
{
    ...
    {        
        ...
        private void imprimirPesoFijo()
        {
            ...
            */
            Frm_BuscarEtiquetas frmBuscarEtiquetas = new Frm_BuscarEtiquetas();
            frmBuscarEtiquetas.ShowDialog();
            catalog_comandos_etiquetas ComandoEtiqueta =  frmBuscarEtiquetas.EtiquetaSeleccionada;
            catalog_comandos_etiquetas ComandoTarima = frmBuscarEtiquetas.TarimaSeleccionada;
